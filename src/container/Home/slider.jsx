  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-300 to-blue-600 mb-[-32px] z-10 relative py-4 px-2 text-center">
          ...
          leading-snug">
            ...
            <span className="underline"> Stable Diffusion</span> and
            <span className="underline"> Stability AI</span>
        ...
        {/* Slider Section */}
        <div className="w-full overflow-hidden bg-[#111] py-16">
          <div
            ref={outerRef}
